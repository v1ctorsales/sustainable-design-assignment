...
const HomeView = () => {
  ...
  return (
    <div className="flex flex-col gap-4 animate-in fade-in">
      ...
      <h3 className="font-semibold text-gray-700 mt-4">Recent News & Alerts</h3>
      {/* Card 1: Today */}
    ...
    <div className="flex flex-col gap-4 animate-in fade-in">
      ...
      <div className="flex flex-col gap-3">
        {forecast.map((item, index) => (
          <Card
            key={index}
            className={`cursor-pointer transition-all ${expandedDay === index ? "border-emerald-500 bg-emerald-50/30" : ""}`}
          >
            <div
